...
- (void)testNSDictionaryGrowingHelper {
    ...
    XCTAssertEqual([dict intForKey:@"id" fallback:1], 12324);
    XCTAssertEqual([dict longlongForKey:@"id" fallback:1], 12324);
    XCTAssertEqual([dict intForKey:@"id2" fallback:1], 1);
    XCTAssertEqual([dict longlongForKey:@"id2" fallback:1], 1);
}
...
- (void)testNSStringGrowingHelper {
    ...
    a = [@"https://www.baidu.com" absoluteURLStringWithPath:@"path" andQuery:@{@"key" : @"value"}];
