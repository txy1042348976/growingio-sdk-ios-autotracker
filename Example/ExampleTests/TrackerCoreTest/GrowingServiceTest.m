...
- (void)unitTest {
    NSLog(@"GrowingServiceTest unitTest");
}

- (void)testGrowingServiceManager {
    [[GrowingServiceManager sharedInstance] registerService:@protocol(GrowingServiceTestProtocol) implClass:[GrowingServiceTest class]];
